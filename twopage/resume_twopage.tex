...
\mobile{(+91) 8427-65-0927}

\email{thakursaurabh1998@gmail.com}
\homepage{www.saurabhthakur.xyz}
...
\position{Sophomore Year Undergraduate{\enskip\cdotp\enskip}Computer
  Science and Engineering} % Your expertise/fields
%\quote{``Make the change that you want to see in the world."} % A
%quote or statement

\makecvfooter{\today}{Saurabh Thakur~~~·~~~Résumé}{\thepage}
